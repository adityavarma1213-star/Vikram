...
for (let i = 0; i < 12; i++) {
  ...
  rows.push({ trade_date: `2026-08-${day}`, close: 100 + i, prev_close: 99 + i, volume: 1000 + i * 100, deliv_per: 45 + i, deliv_qty: 500 + i, turnover: 60000000 });
}
rows.push({ trade_date: '2026-09-01', close: 115, prev_close: 114, volume: 2500, deliv_per: 60, deliv_qty: 1500, turnover: 60000000 });

const futures = new Map([
  ['AAA|2026-09-01', { available: true, trade_date: '2026-09-01', oi: 50000, change_oi: 4000 }]
]);
