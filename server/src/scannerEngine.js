...
function evaluate(symbol, history, futures) {
  ...
  if (futuresOi !== null && changeOi !== null) add(CFG.weights.futuresOi, changeOi > 0 ? 30 : changeOi === 0 ? 12 : 0, changeOi > 0 ? `Futures OI increased by ${changeOi} on the exact date.` : `Futures OI change is ${changeOi}.`); else why.push('Futures OI confirmation is unavailable for the exact date.');
